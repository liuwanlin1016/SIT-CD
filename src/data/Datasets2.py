...
from Config import batch_size_val, batch_size_test, LEVIR2_dir
...
test_dataset = LoveDADataset(
    imageA_dir=os.path.join(LEVIR2_dir, "test/A"),
    imageB_dir=os.path.join(LEVIR2_dir, "test/B"),
    label_dir=os.path.join(LEVIR2_dir,  "test/label"),
